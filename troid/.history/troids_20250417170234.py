...
hidden_size1 = 64  # Gizli katman boyutunu artırıyoruz
hidden_size2 = 32  # İkinci bir gizli katman ekliyoruz
output_size = 1
epochs = 5000  # Epoch sayısını artırıyoruz
learning_rate = 0.001  # Öğrenme oranını küçültüyoruz
